      ...
      <div className="container max-w-screen-xl p-4 mx-auto text-[var(--CL-primary-gray)]">
        <div className="grid md:grid-cols-2">
          <header className="mb-5 text-center md:text-left md:flex md:flex-col md:justify-center">
            ...
            <div className="flex items-center justify-end md:justify-start md:mt-4 lg:mt-20 lg:gap-4">
          ...
          <div className="relative">
            ...
            <Link
              to="/"
              className="absolute bottom-0 left-0 px-8 py-5 text-xs tracking-widest uppercase bg-white text-[var(--CL-primary-gray)]"
            >
              View Project
